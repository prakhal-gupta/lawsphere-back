    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('supreme_court', 'Supreme Court'), ('high_court', 'High Court'), ('district_court', 'District Court'), ('family_court', 'Family Court'), ('consumer_court', 'Consumer Court'), ('labour_court', 'Labour Court'), ('civil_court', 'Civil Court'), ('criminal_court', 'Criminal Court'), ('tax_court', 'Tax Court'), ('tribunal', 'Tribunal')], max_length=64)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bar_id', models.CharField(max_length=100, unique=True, verbose_name='Bar Council ID')),
                ...
                ('past_cases', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=128), blank=True, default=list, size=None)),
                ('is_active', models.BooleanField(default=True)),
                ('court', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='admin_settings.court')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='judge_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
