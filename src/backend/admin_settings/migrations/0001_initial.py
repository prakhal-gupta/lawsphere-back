    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('court_level', models.CharField(choices=[('district', 'District Court'), ('sessions', 'Sessions Court'), ('high', 'High Court'), ('supreme', 'Supreme Court'), ('tribunal', 'Tribunal')], max_length=32)),
