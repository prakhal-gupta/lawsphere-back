...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '13.53.138.177', 'https://lawsphere-front.vercel.app/']
...
MIDDLEWARE = [
    ...
    # 'backend.middleware.CheckCourtMiddleware'
]
...
CORS_ALLOW_HEADERS = ["court", "customer"] + list(default_headers)
